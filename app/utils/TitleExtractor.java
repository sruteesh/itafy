 ...
 * 
 * See:
 * gotoquiz.com/web-coding/programming/java-programming/how-to-extract-titles
 * -from-web-pages-in-java/
 * 
...
public class TitleExtractor {
	...
	private static final class ContentType {
		private static final Pattern CHARSET_HEADER =
				Pattern.compile("charset=([-_a-zA-Z0-9]+)", Pattern.CASE_INSENSITIVE | Pattern.DOTALL);
